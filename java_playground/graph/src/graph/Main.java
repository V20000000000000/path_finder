...
public class Main {
    public static void main(String[] args) {
        Graph<VertexProperty<Integer>, EdgeProperty<Integer>> graph = new Graph<>(5);
        ...
        System.out.println("Vertex property of vertex 0: " + vp.value);

        // Get edge property
        EdgeProperty<Integer> ep = graph.getEdgeProperty(0, 1);
        System.out.println("Edge property of edge (0, 1): " + ep.value);
